...
{block name="content"}
            ...
            <div class="widget flat no-margin">
                ...
                <div class="widget-body plugins_category-">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="well">
                                <form action="{:url('articleCategory/edit')}" id="form-edit" class="form-horizontal bv-form form-category" data-action="edit" onsubmit="return false;" autocomplete="off">
    ...
    <div id="addModal" style="display:none;">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal bv-form form-category" method="post" data-action="add" action="{:url('articleCategory/add')}" autocomplete="off"></form>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('.plugins_category- table').find('.btn-get').click(function(){
                ...
                $.fruiter.post("{:url('articleCategory/getCategory')}",{id:$(tr).data('id')},function(data){
                    if(data){
                        category_id = data.id;
