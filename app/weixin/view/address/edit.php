                ...
                <ul>
                        ...
                        <div class="item-content">
                            <div class="item-inner">
                                <div class="item-input">
                                    <input name="consignee" value="{$address.consignee??''}" placeholder="收货人" maxlength="8" type="text">
                                </div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="item-content">
                            <div class="item-inner">
                                <div class="item-input">
                                    <input name="mobile" value="{$address.mobile??''}" placeholder="收货人手机号" maxlength="11" type="tel">
                                </div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="item-content">
                            <div class="item-inner">
                                <div class="item-input">
                                    <input name="area" value="{$address.area??''}" id="city-picker" placeholder="省、市、区/县" type="text" readonly>
                                </div>
                            </div>
                        </div>
                    </li>
                            ...
                            <div class="item-inner">
                                ...
                                <div class="item-input">
                                    <label class="label-switch">
                                        <input name="is_default" value="1" type="checkbox" class="hidden" {$address.is_default?'checked':''}>
