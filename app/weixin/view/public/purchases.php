    ...
    <section class="product-purchasing">
        ...
        <div class="product-panel">
            ...
            <div class="product-select-box">
                <div class="product-property-type"><h3 class="property-type">颜色</h3><ul class="property-box"><li class="property-item selected">红色</li><li class="property-item">红色</li></ul></div>
                <div class="product-property-type"><h3 class="property-type">颜色</h3><ul class="property-box"><li class="property-item selected">红色</li><li class="property-item">红色</li></ul></div>
